...
export type ContractContext = EthersContractContextV5<
  OtentixContract,
  OtentixContractMethodNames,
  OtentixContractEventsContext,
  OtentixContractEvents
>;
...
export type OtentixContractEvents =
  | 'Approval'
  | 'ApprovalForAll'
  | 'NftItemCreated'
  | 'OwnershipTransferred'
  | 'Transfer';
export interface OtentixContractEventsContext {
...
export type OtentixContractMethodNames =
  | 'new'
  | 'approve'
  | 'balanceOf'
  | 'getApproved'
...
export interface OtentixContract {
  /**
   * Payable: false
   * Constant: false
