...
import { OtentixContract } from "@_types/otentixContract";
  ...
  useEffect(() => {
    async function initWeb3() {
      try {
        ...
        const contract =  await loadContract("Otentix", provider);
        ...
        setWeb3Api(createWeb3State({
          ...
          provider,
          contract: signedContract as unknown as OtentixContract,
          isLoading: false
        }))
      } catch(e: any) {
